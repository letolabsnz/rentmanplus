  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-xs text-gray-500 mt-0.5">Shown in the app header and on the browser tab.</p>
      </div>
        ...
        <div className="card p-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-gray-500">
              Used for the browser tab title instead, since there's little room there for the full name. Falls back
              to the business name, then "Rentman+", if left blank.
            </p>
          </div>
